                        ...
                        <List>
                            {
                                this.state.brandList.map(function (brand, brandIndex) {
                                    return (
                                        <List.Item key={brand.brand_id} arrow="horizontal"
                                                   onClick={this.onClickListItem.bind(this, brand.brand_id)}>
                                            <div style={{display: '-webkit-box', display: 'flex'}}>
                                                <img style={{width: 64, marginRight: 8}}
                                                     src={Helper.host + brand.brand_logo}/>
                                                ...
                                                <div style={{
                                                    ...
                                                    top: '30px',
                                                    color: '#888'
                                                }}>{brand.brand_apply_review_status}</div>
                                            </div>
                                        </List.Item>
                                    )
                                }.bind(this))
